...
const Details = () => {
  ...
  return (
    <section className="py-10">
      <Link to="/">
        <img className="max-w-lg mx-auto" src={logo} alt="montaProduct" />
      </Link>
      <div> Home/Category/cars/mercedes</div>
      <div className="flex gap-10">
        ...
        <div className="w-5/12">
          <div className="flex justify-between">
            <h1 className=" text-2xl font-semibold"> mercedes </h1>
            <div>
              <ul class="flex justify-center drop-shadow-lg">
                <li>
                  <svg
                    aria-hidden="true"
                    focusable="false"
          ...
          <div className="pl-7  pt-7">
            <div>
              <div className="font-medium text-base pl-3 pb-5"> 52255 TND</div>
              <p>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsam
                illo quaerat, odit sint possimus veniam cum itaque minima eaque
                eum nihil quis natus quas, aliquid laboriosam? Aliquid eveniet
                vitae architecto repellat voluptatibus. Harum neque temporibus
                adipisci consectetur consequuntur! Nesciunt tenetur maiores
                voluptate incidunt voluptas est consequatur neque accusantium.
                Labore, odio?
              </p>
              ...
              <div className="pt-10">
                ...
                <div className="pl-5">
                  ...
                  Magni consectetur est ratione natus soluta. Illo ipsum illum,
                  omnis nisi officiis non nostrum possimus maiores quia,
                  perspiciatis incidunt, id eius. Distinctio molestiae vel,
                  quisquam ullam similique asperiores cupiditate? Aspernatur
                  ipsam earum corporis obcaecati suscipit voluptatibus explicabo
                  numquam beatae, quod a modi.
                </div>
              </div>
      ...
      <div className="flex gap-20 border  items-center border-cyan-500 mx-auto max-w-max rounded shadow-2xl mt-32 max-h-24 px-10 py-[3.5rem]">
        ...
        <div className="flex justify-between items-center gap-2">
          <div className="rounded-full w-5 h-5  bg-Warning">-</div>
